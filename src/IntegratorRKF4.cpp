...
IntegratorRKF4::IntegratorRKF4(IModel *pModel, double h)
    ...
    ,m_state(new double[pModel->GetDim()])
    ,m_tmp(new double[pModel->GetDim()])
    ,m_k1(new double[pModel->GetDim()])
    ,m_k2(new double[pModel->GetDim()])
    ,m_k3(new double[pModel->GetDim()])
    ,m_k4(new double[pModel->GetDim()])
    ,m_k5(new double[pModel->GetDim()])
    ,m_k6(new double[pModel->GetDim()])
    ,m_error(new double[pModel->GetDim()])
    ,m_maxErr(0.005)
{
    if (pModel == nullptr)
